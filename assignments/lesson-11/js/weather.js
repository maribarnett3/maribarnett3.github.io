...
function forecast(jsonObj) {
    ...
    for (let i = 0; i < forecastsAt18.length; i++) {
        var innerHTML = `<img alt="openweathermap image" src="https://openweathermap.org/img/w/` + forecastsAt18[i].weather[0].icon + `.png" alt="` + forecastsAt18[i].weather[0].description + `" width="50">` + forecastsAt18[i].main.temp + `&#176;`
